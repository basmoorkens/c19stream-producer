...
public class KinesisService {
	...
	public void writeCovidEntriesToKinesisStream(List<CovidEntry> covidEntries) throws InterruptedException {
		...
		//fetch the aws creds from system env
		...
		for (CovidEntry covidEntry : covidEntries) {
			...
			//basic batching system, we create 500 records, push them to kinesis and then wait 1s to make sure we do not hit the rate limit
